...
parser.add_argument('--crop_size', default=88, type=int, help='val images crop size')
parser.add_argument('--patch_size', default=44, type=int, help='training images patch size')
...
if __name__ == '__main__':
    ...
    train_set = TrainDatasetFromFolder('D:\SRGAN\DIV2K\DIV2K_train_HR', crop_size=CROP_SIZE, upscale_factor=UPSCALE_FACTOR)
    val_set = ValDatasetFromFolder('D:\SRGAN\DIV2K\DIV2K_valid_HR', upscale_factor=UPSCALE_FACTOR)
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        with torch.no_grad():
            ...
            valing_results = {'mse': 0, 'ssims': 0, 'psnr': 0, 'batch_sizes': 0}
            val_images = []
